...
def calculate_demographic_data(print_data=True):
    ...
    # 4 & 5. Advanced education: Bachelors, Masters, or Doctorate
    ...
    # 7. What percentage of people who work the minimum hours per week have a salary >50K?
    min_workers = df[df['hours-per-week'] == min_work_hours]
    rich_min_workers = (min_workers['salary'] == '>50K').mean()
    rich_percentage = round(rich_min_workers * 100, 1)

    # 8. What country has the highest percentage of people that earn >50K?
    country_rich_ratio = df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()
